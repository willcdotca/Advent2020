let raw = `drab tan bags contain 4 clear gold bags.
...
dim chartreuse bags contain 3 shiny gold bags, 2 mirrored olive bags.`.split(
    /\n/g);
...
let c1 = b => {
  if (!a1[b]) return a1[b];
  if (a1[b].includes(g)) return true;
